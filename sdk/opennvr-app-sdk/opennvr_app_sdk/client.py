...
class _Http:
    ...
    def post_json(self, path: str, body: Any, **params) -> Any:
        url = f"{self.base}{path}{query_string(params)}"
        try:
            r = self._client.post(url, json=body, headers=self.headers())
        except Exception as exc:  # noqa: BLE001
...
class TimelineAPI:
    ...
    def plates_inside(self, *, in_cameras: Iterable = (),
    ...
    def visit_at(self, camera, at, *, label: str | None = None,
    ...
    def add_claims(self, event_id: int, claims, *, binding: str = "direct",
                   ran_tasks=()) -> dict:
