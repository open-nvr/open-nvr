...
"""
KAI-C Startup Script (No Reload)

Run this to start the KAI-C HTTP service without auto-reload.
"""
...
if __name__ == "__main__":
    print("=" * 70)
    print("Starting KAI-C (Kavach AI Connector) HTTP Service - NO RELOAD")
    print("=" * 70)
    print()
