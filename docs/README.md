...
- **[HOME_ASSISTANT_USER_GUIDE.md](HOME_ASSISTANT_USER_GUIDE.md)** — what OpenNVR gives Home Assistant, how to connect (MQTT discovery today, the native integration when released), automations, troubleshooting.
