...
| HA-005 | deferred to M0 end | — | — | Needs the dev stack stopped (e2e and dev containers collide on `container_name`); ask the owner for a window. |
...
| M0 exit | pending | — | — | HA-005 (e2e) needs a stack-down window, then milestone-end review and push decision. |
