...
_ROUTE_WRAPPERS: dict[str, str] = {
    ...
    "GET /plates/inside": "plates_inside",
    "GET /visits/at": "visit_at",
    "POST /visits/claims": "add_claims",
    "GET /alerts": "inbox",
...
_DOCUMENTED_AS_A_GROUP = {
    ...
    "GET /plates/inside": "/internal/app/plates/*",
    "GET /visits/at": "/internal/app/visits/at",
    "POST /visits/claims": "/internal/app/visits/claims",
